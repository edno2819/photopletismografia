...
def calcular_fc(raw_ppg, fs):
    ...
    # For Tanh Function
    axis[1, 1].plot(t, ppg_filtrado)
    axis[1, 1].set_title("sinal fft de amplitude em frequência")
...
if __name__ == "__main__":
    ...
    print('Por favor selecione seu arquivo csv')
    path_csv = easygui.fileopenbox()
    if args.captura:
